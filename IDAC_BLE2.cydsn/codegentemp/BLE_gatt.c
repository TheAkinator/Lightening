    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'I', (uint8)'D', (uint8)'A', (uint8)'C', (uint8)' ', (uint8)'B', (uint8)'L', (uint8)'E', 
...
const uint8 cyBle_attUuid128[][16u] = {
    /* IDAC */
    { 0x00u, 0x00u, 0x00u, 0x00u, 0xFBu, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x78u, 0x56u, 0x34u, 0x12u },
    /* Change IDAC */
    { 0x00u, 0x00u, 0x00u, 0xB0u, 0x4Fu, 0xB3u, 0xF9u, 0x05u, 0x08u, 0x00u, 0x00u, 0x08u, 0x79u, 0x56u, 0x34u, 0x12u },
    /* Start Motor */
    { 0x00u, 0x00u, 0x00u, 0xB0u, 0x4Fu, 0xB3u, 0xF9u, 0x05u, 0x08u, 0x00u, 0x00u, 0x08u, 0x77u, 0x56u, 0x34u, 0x12u },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* IDAC UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[1] }, /* Change IDAC UUID */
    { 0x0001u, (void *)&cyBle_attValues[22] }, /* Change IDAC */
    { 0x0010u, (void *)&cyBle_attUuid128[2] }, /* Start Motor UUID */
    { 0x0001u, (void *)&cyBle_attValues[23] }, /* Start Motor */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x10u] = {
    ...
    { 0x000Du, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr  */, 0x000Eu, {{0x0010u, (void *)&cyBle_attValuesLen[6]}} },
    { 0x000Eu, 0x5679u /* Change IDAC                         */, 0x00080A04u /* rd,wr  */, 0x000Eu, {{0x0001u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x000Fu, 0x2803u /* Characteristic                      */, 0x00000A01u /* rd,wr  */, 0x0010u, {{0x0010u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0010u, 0x5677u /* Start Motor                         */, 0x00080A04u /* rd,wr  */, 0x0010u, {{0x0001u, (void *)&cyBle_attValuesLen[9]}} },
};
