...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* IDAC service */
    {
        0x000Cu, /* Handle of the IDAC service */ 
        {

            /* Change IDAC characteristic */
            {
                0x000Eu, /* Handle of the Change IDAC characteristic */ 
            ...
            /* Start Motor characteristic */
            {
                0x0010u, /* Handle of the Start Motor characteristic */ 
