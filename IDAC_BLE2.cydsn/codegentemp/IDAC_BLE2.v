// ======================================================================
// IDAC_BLE2.v generated from TopDesign.cysch
// 07/21/2015 at 16:29
...
// IDAC_P4_v1_10(IDACRange=1, IDACValue=120, Polarity=0, Resolution=8, CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC, CY_INSTANCE_SHORT_NAME=IDAC, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=IDAC, )
...
module top ;
	...
	wire [0:0] tmpOE__MyPin_net;
	wire [0:0] tmpFB_0__MyPin_net;
	wire [0:0] tmpIO_0__MyPin_net;
	wire [0:0] tmpINTERRUPT_0__MyPin_net;
	electrical [0:0] tmpSIOVREF__MyPin_net;
	...
	cy_psoc3_pins_v1_10
		...
		MyPin
		 (.oe(tmpOE__MyPin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MyPin_net[0:0]}),
		  .analog({Net_4005}),
		  .io({tmpIO_0__MyPin_net[0:0]}),
		  .siovref(tmpSIOVREF__MyPin_net),
		  .interrupt({tmpINTERRUPT_0__MyPin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MyPin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
