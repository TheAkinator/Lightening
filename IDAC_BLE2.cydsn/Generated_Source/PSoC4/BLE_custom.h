...
#define CYBLE_IDAC_SERVICE_INDEX   (0x00u) /* Index of IDAC service in the cyBle_customs array */
#define CYBLE_IDAC_CHANGE_IDAC_CHAR_INDEX   (0x00u) /* Index of Change IDAC characteristic */
#define CYBLE_IDAC_START_MOTOR_CHAR_INDEX   (0x01u) /* Index of Start Motor characteristic */


#define CYBLE_IDAC_SERVICE_HANDLE   (0x000Cu) /* Handle of IDAC service */
#define CYBLE_IDAC_CHANGE_IDAC_CHAR_HANDLE   (0x000Eu) /* Handle of Change IDAC characteristic */
#define CYBLE_IDAC_START_MOTOR_CHAR_HANDLE   (0x0010u) /* Handle of Start Motor characteristic */
